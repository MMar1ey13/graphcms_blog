...
const PostCard = ({ post }) => {
  ...
  return (
    <div className='bg-sky-950 shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <h1 className='transition duration-700 text-white text-center mb-8 cursor-pointer hover:text-pink-600 text-3xl font-semibold'>
      ...
      <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
        <div className='flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8'>
          <img
            ...
            />
            <p className='inline align-middle text-gray-100 ml-2 font-medium text-lg'>{post.author.name}</p>
        </div>
       ...
       <p className="text-center text-lg text-gray-100 font-normal px-4 lg:px-20 mb-8">
      {post.excerpt}
    </p>
